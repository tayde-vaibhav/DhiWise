                ...
                <div className="flex flex-col items-start justify-start w-full">
                  <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                    ...
                    <div className="flex sm:flex-1 flex-row gap-[15px] items-center justify-between w-[39%] sm:w-full">
                      ...
                      <Button
                        className="cursor-pointer flex items-center justify-center min-w-[101px] my-1 rounded"
                        leftIcon={
                          <Img
                ...
                <div className="flex flex-col gap-8 items-start justify-start w-full">
                  ...
                  <div className="flex sm:flex-col flex-row gap-2.5 items-center justify-start w-3/5 md:w-full">
                    <div className="bg-gray-100_90 h-5 relative rounded w-[11%] sm:w-full">
                      ...
                      <Button
                        className="absolute cursor-pointer font-inter h-full inset-[0] justify-center m-auto min-w-[38px] rounded text-center text-xs"
                        color="gray_100_90"
                        size="sm"
                        variant="fill"
                      >
                    ...
                    <Button
                      className="cursor-pointer min-w-[70px] rounded text-center text-xs"
                      color="gray_100_90"
                      size="sm"
                      variant="fill"
                    >
                    ...
                    <Button
                      className="cursor-pointer min-w-[44px] rounded text-center text-xs"
                      color="gray_100_90"
                      size="sm"
                      variant="fill"
                    >
                    ...
                    <Button
                      className="cursor-pointer min-w-[49px] rounded text-center text-xs"
                      color="gray_100_90"
                      size="sm"
                      variant="fill"
                    >
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex flex-row items-center justify-between mt-[30px] w-full">
                      ...
                      <Button
                        className="cursor-pointer font-medium min-w-[82px] rounded text-center text-sm"
                        color="gray_500_99"
                        size="lg"
                        variant="outline"
                      >
